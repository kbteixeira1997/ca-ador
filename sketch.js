...
function setup() {
  ...
  camelo1 = new Animal(width - 300, 330, 100, 100, "assets/camelo1.png");
  macaco1 = new Animal(width - 550, height - 300, 100, 100, "assets/macaco1.png");
}
